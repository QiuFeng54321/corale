...
entry:
  ...
  %0 = alloca [3 x [2 x i64]], align 8
  store [3 x [2 x i64]] [[2 x i64] [i64 3, i64 4], [2 x i64] [i64 4, i64 3], [2 x i64] [i64 3, i64 4]], [3 x [2 x i64]]* %0, align 8
  %_load.0 = load [3 x [2 x i64]], [3 x [2 x i64]]* %0, align 8
  %1 = bitcast [3 x [2 x i64]] %_load.0 to i64**
  store i64** %1, i64*** %_arr.0, align 8
  ret void
}
