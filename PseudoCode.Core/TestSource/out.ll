...
condition:                                        ; preds = %entry
  %_load.0 = load i64, i64* %i, align 8
  %_bool.0 = icmp sgt i64 %_load.0, 2
  %_bool.1 = and i1 true, %_bool.0
  %_load.1 = load i64, i64* %i, align 8
  %_bool.2 = icmp slt i64 %_load.1, 2
...
continue:                                         ; preds = %block, %condition
  %_load.10 = load i64**, i64*** %arr2d, align 8
  %_int.4 = getelementptr inbounds i64*, i64** %_load.10, i64 2
  %1 = getelementptr inbounds i64*, i64** %_int.4, i64 0
  %_load.11 = load i64*, i64** %1, align 8
  %_int.5 = getelementptr inbounds i64, i64* %_load.11, i64 2
  %2 = getelementptr inbounds i64, i64* %_int.5, i64 0
  %_load.12 = load i64, i64* %2, align 8
  call void @__PRINTF(i64 %_load.12)
  call void @__PRINTF.1(i8 10)
  ret void

block:                                            ; preds = %increment, %condition
  %_load.2 = load i64, i64* %i, align 8
  %_int.0 = mul i64 %_load.2, 2
  %_load.3 = load i64, i64* %i, align 8
  %_int.1 = mul i64 %_load.3, 3
  %_load.4 = load i64, i64* %i, align 8
  %3 = alloca [3 x i64], align 8
  %4 = getelementptr inbounds i64, [3 x i64]* %3, i64 0
  store i64 %_load.4, i64* %4, align 8
  %5 = getelementptr inbounds i64, [3 x i64]* %3, i64 1
  store i64 %_int.0, i64* %5, align 8
  %6 = getelementptr inbounds i64, [3 x i64]* %3, i64 2
  store i64 %_int.1, i64* %6, align 8
  %_load.5 = load i64**, i64*** %arr2d, align 8
  %_load.6 = load i64, i64* %i, align 8
  %_int.2 = getelementptr inbounds i64*, i64** %_load.5, i64 %_load.6
  %7 = getelementptr inbounds i64*, i64** %_int.2, i64 0
  %8 = alloca [3 x i64], align 8
  %_load.7 = load [3 x i64], [3 x i64]* %3, align 8
  store [3 x i64] %_load.7, [3 x i64]* %8, align 8
  %9 = bitcast [3 x i64]* %8 to i64*
  store i64* %9, i64** %7, align 8
  %_load.8 = load i64, i64* %i, align 8
  %_bool.5 = icmp eq i64 %_load.8, 2
  br i1 %_bool.5, label %continue, label %increment

increment:                                        ; preds = %block
  %_load.9 = load i64, i64* %i, align 8
  %_int.3 = add i64 %_load.9, 1
  store i64 %_int.3, i64* %i, align 8
  br label %block
}
